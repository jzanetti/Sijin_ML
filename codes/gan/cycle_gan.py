...
# write your own dataset using https://stackoverflow.com/questions/44429199/how-to-load-a-list-of-numpy-arrays-to-pytorch-dataset-loader
dataloader = DataLoader(
    ImageDataset(
        os.path.join(opt.img_dir, opt.dataset_name),
